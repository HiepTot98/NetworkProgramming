 ...
 * @author Saker
 */
@WebServlet(name = "SearchController", urlPatterns = {"/SearchControl"})
public class SearchController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // duyet mang cho mang ki tu vao list tim kiem
            ...
            //begin of set list 
            List<Digital> list = digitalDAO.getTop5(top1.getId());
            request.setAttribute("top5", list);
            //Keeping text Search
            request.setAttribute("KeepingText", txt);
            //List Keeping text
            
            //end of set list
            request.getRequestDispatcher("jsp/SearchResultPage.jsp").forward(request, response);
        } catch (Exception e) {
        }
    }
